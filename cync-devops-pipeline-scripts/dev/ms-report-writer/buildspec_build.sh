...
appPrefix="cync-report-writer-0.0.1-SNAPSHOT_" 
...
aws s3 cp target/cync-report-writer-0.0.1-SNAPSHOT.jar s3://$artifact_bucket/$artifactversion  
...
#aws s3 sync target/reports/ s3://$reports_bucket/report-writer/ 
